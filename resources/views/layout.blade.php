...
<html lang="vi">
   <head>
      ...
      <meta property="og:site_name" content="Linh phim" />
      ...
      </style>      <style>#header .site-title {background: url(https://uxwing.com/wp-content/themes/uxwing/download/video-photography-multimedia/movie-icon.png) no-repeat top left;background-size: contain;text-indent: -9999px;}</style>
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
                  ...
                  <div class="header-nav">
                     <div class="col-xs-12">
                        ...
                        <div class="form-group">
                           {{-- <form action="{{route('add-movie')}}" method="GET">
         ...
         <div class="container">
            <nav class="navbar halim-navbar main-navigation" role="navigation" data-dropdown-hover="1">
               ...
               <div class="collapse navbar-collapse" id="halim">
                  ...
                  <ul class="nav navbar-nav navbar-left" style="background:#337AB7;">
                     <li><a href="#" onclick="locphim()" style="color: #fff;">Lọc Phim</a></li>
                  </ul>
                  <ul class="nav navbar-nav navbar-left" style="background:#528D25;">
                     <li><a href="{{route('addMovie')}}" style="color: #fff;">Thêm Phim</a></li>
                  </ul>
               </div>
            </nav>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="img-responsive" src="" alt="Linh phim" />
                  </div>
                  Liên hệ QC: <a href="" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">Hehe</a>
               </div>
            </div>
         </div>
      </footer>
      ...
      <script>
         document.addEventListener('DOMContentLoaded', function() {
             var tabs = document.querySelectorAll('.halim-popular-tab li');
...
<script>
    $(document).ready(function() {
        // Ẩn tất cả các phần nội dung trừ phần có ID là view-by-day
        $('#view-by-year, #view-by-month, #view-all').hide();

        // Xử lý sự kiện khi nhấn vào nút có class là "show-view-day"
        $('.show-view-day').click(function(e) {
            e.preventDefault();
            showContent('view-by-day');
        });

        // Xử lý sự kiện khi nhấn vào nút có class là "show-view-year"
        $('.show-view-year').click(function(e) {
            e.preventDefault();
            showContent('view-by-year');
        });

        // Xử lý sự kiện khi nhấn vào nút có class là "show-view-month"
        $('.show-view-month').click(function(e) {
            e.preventDefault();
            showContent('view-by-month');
        });

        // Xử lý sự kiện khi nhấn vào nút có class là "show-view-all"
        ...
        function showContent(contentId) {
            ...
            $('#view-by-day, #view-by-year, #view-by-month, #view-all').hide();
      ...
      <script>
         ...
         owl.owlCarousel({
            ...
            responsive: {0: {items:2},480: {items:3}, 600: {items:4},1000: {items: 5}}
            })
         });
      </script>
   ...
   <script src="https://kit.fontawesome.com/85f1e975d9.js" crossorigin="anonymous"></script>
   <div id="fb-root"></div>
   <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="2ZjPL4a6"></script>
</html>